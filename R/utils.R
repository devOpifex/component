...
make_ui <- function(params) {
  ...
  wl$w("\t\t\tshiny::tags$style(shiny::HTML(.", params$component, "_css(...) |> component::namespace(ns))),")
  wl$w("\t\t\tshiny::tags$script(shiny::HTML(.", params$component, "_javascript(...) |> component::namespace(ns)))")
  wl$w("\t\t),")
